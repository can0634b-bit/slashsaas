        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {securityPoints.map((point, idx) => {
            ...
            return (
              ...
              >
                <div>
                  <div className="mb-5 flex h-10 w-10 items-center justify-center rounded-2xl bg-white/10 text-emerald-400">
                ...
                <div className="mt-6 pt-4 border-t border-white/[0.06] flex items-center gap-1 text-[11px] text-emerald-400 font-semibold">
