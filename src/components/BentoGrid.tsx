...
export const BentoGrid: React.FC = () => {
  return (
    <section id="solutions" className="py-24 border-t border-zinc-200 dark:border-white/[0.06] bg-zinc-50/50 dark:bg-zinc-950/40 relative">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="md:col-span-2 rounded-3xl border border-zinc-200/80 dark:border-white/[0.08] bg-white dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-white/[0.01] p-8 flex flex-col justify-between hover:border-zinc-300 dark:hover:border-white/20 transition-all group shadow-sm dark:shadow-xl">
            <div>
              <div className="flex items-center justify-between mb-6">
                <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-zinc-100 dark:bg-white/10 text-zinc-900 dark:text-white font-bold">
            ...
            <div className="mt-8 rounded-2xl border border-zinc-200/80 dark:border-white/[0.06] bg-zinc-50 dark:bg-black/40 p-4 flex items-center justify-between text-xs text-zinc-700 dark:text-zinc-300">
              <span className="flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-emerald-500 dark:bg-emerald-400" />
                Dormancy Algorithm: 30 / 60 / 90+ Day Granular Classification
              </span>
              <span className="text-emerald-600 dark:text-emerald-400 font-bold">100% Accuracy</span>
            </div>
          </div>

          {/* Card 2 (Single col) */}
          <div className="rounded-3xl border border-zinc-200/80 dark:border-white/[0.08] bg-white dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-white/[0.01] p-8 flex flex-col justify-between hover:border-zinc-300 dark:hover:border-white/20 transition-all group shadow-sm dark:shadow-xl">
            <div>
              <div className="flex items-center justify-between mb-6">
                <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-zinc-100 dark:bg-white/10 text-zinc-900 dark:text-white font-bold">
            ...
            <div className="mt-6 pt-4 border-t border-zinc-100 dark:border-white/[0.06] text-xs text-zinc-500 dark:text-zinc-400 flex items-center gap-1.5">
          ...
          <div className="rounded-3xl border border-zinc-200/80 dark:border-white/[0.08] bg-white dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-white/[0.01] p-8 flex flex-col justify-between hover:border-zinc-300 dark:hover:border-white/20 transition-all group shadow-sm dark:shadow-xl">
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-[11px] font-semibold text-amber-600 dark:text-amber-400 bg-amber-500/10 px-3 py-1 rounded-full border border-amber-500/20">
                  Shadow IT Radar
                </span>
              </div>
          ...
          <div className="md:col-span-2 rounded-3xl border border-zinc-200/80 dark:border-white/[0.08] bg-white dark:bg-gradient-to-b dark:from-white/[0.04] dark:to-white/[0.01] p-8 flex flex-col justify-between hover:border-zinc-300 dark:hover:border-white/20 transition-all group shadow-sm dark:shadow-xl">
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-[11px] font-semibold text-purple-600 dark:text-purple-400 bg-purple-500/10 px-3 py-1 rounded-full border border-purple-500/20">
                  Finance & Accounting
                </span>
              </div>
            ...
            <div className="mt-8 rounded-2xl border border-zinc-200/80 dark:border-white/[0.06] bg-zinc-50 dark:bg-black/40 p-4 flex items-center justify-between text-xs text-zinc-700 dark:text-zinc-300">
              ...
              <span className="text-purple-600 dark:text-purple-400 font-bold">1-Click Export</span>
            </div>
          </div>
        </div>
      </div>
